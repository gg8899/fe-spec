...
describe('Validate JS configs', () => {
  it('Validate encode-gg-eslint-config', async () => {
  ...
  it('Validate encode-gg-eslint-config/es5', async () => {
  ...
  it('Validate encode-gg-eslint-config/vue', async () => {
  ...
  it('Validate encode-gg-eslint-config/essential', async () => {
  ...
  it('Validate encode-gg-eslint-config/essential/es5', async () => {
  ...
  it('Validate encode-gg-eslint-config/essential/react', async () => {
  ...
  it('Validate encode-gg-eslint-config/essential/vue', async () => {
  ...
  it('Validate encode-gg-eslint-config/node', async () => {
