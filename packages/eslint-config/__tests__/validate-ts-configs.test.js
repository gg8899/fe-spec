...
describe('Validate TS configs', () => {
  it('Validate eslint-config-ggbee/typescript', async () => {
  ...
  it('Validate eslint-config-ggbee/typescript/vue', async () => {
  ...
  it('Validate eslint-config-ggbee/essential/typescript', async () => {
  ...
  it('Validate eslint-config-ggbee/essential/typescript/react', async () => {
  ...
  it('Validate eslint-config-ggbee/essential/typescript/vue', async () => {
  ...
  it('Validate eslint-config-ggbee/typescript/node', async () => {
